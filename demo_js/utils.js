const btf = {
    debounce: function (t, e, n) {
        let o;
        return function () {
            const i = this, a = arguments, r = function () {
                o = null, n || t.apply(i, a)
            }, s = n && !o;
            clearTimeout(o), o = setTimeout(r, e), s && t.apply(i, a)
        }
    },
    throttle: function (t, e, n) {
        ...
        n || (n = {});
        const s = function () {
            r = !1 === n.leading ? 0 : (new Date).getTime(), o = null, t.apply(i, a), o || (i = a = null)
        };
        return function () {
            const l = (new Date).getTime();
            r || !1 !== n.leading || (r = l);
            const c = e - (l - r);
            i = this, a = arguments, c <= 0 || c > e ? (o && (clearTimeout(o), o = null), r = l, t.apply(i, a), o || (i = a = null)) : o || !1 === n.trailing || (o = setTimeout(s, c))
        }
    },
    sidebarPaddingR: () => {
        const t = window.innerWidth, e = document.body.clientWidth, n = t - e;
    ...
    snackbarShow: (t, e = !1, n = 2e3) => {
        ...
        Snackbar.show({text: t, backgroundColor: r, showAction: e, duration: n, pos: o, customClass: "snackbar-css"})
    },
    diffDate: (t, e = !1) => {
        const n = new Date, o = new Date(t), i = n.getTime() - o.getTime(), a = 36e5, r = 24 * a;
        let s;
        if (e) {
            const t = i / 2592e6, e = i / r, n = i / a, l = i / 6e4;
    ...
    scrollToDest: (t, e = 500) => {
        ...
        if (n > t && (t -= 70), "scrollBehavior" in document.documentElement.style) return void window.scrollTo({
            top: t,
            behavior: "smooth"
        });
        let o = null;
        t = +t, window.requestAnimationFrame((function i(a) {
            o = o || a;
            const r = a - o;
            n < t ? window.scrollTo(0, (t - n) * r / e + n) : window.scrollTo(0, n - (n - t) * r / e), r < e ? window.requestAnimationFrame(i) : window.scrollTo(0, t)
        }))
    },
    animateIn: (t, e) => {
    ...
    animateOut: (t, e) => {
        t.addEventListener("animationend", (function e() {
            t.style.display = "", t.style.animation = "", t.removeEventListener("animationend", e)
        })), t.style.animation = e
    },
    getParents: (t, e) => {
    ...
    wrap: (t, e, n) => {
        ...
        for (const [t, e] of Object.entries(n)) o.setAttribute(t, e);
    ...
    getEleTop: t => {
        let e = t.offsetTop, n = t.offsetParent;
    ...
    loadLightbox: t => {
        ...
        if ("mediumZoom" === e) {
            ...
            e.on("open", (t => {
                ...
                e.update({background: n})
            }))
        }
        "fancybox" === e && (t.forEach((t => {
            if ("A" !== t.parentNode.tagName) {
                const e = t.dataset.lazySrc || t.src, n = t.title || t.alt || "";
                btf.wrap(t, "a", {href: e, "data-fancybox": "gallery", "data-caption": n, "data-thumb": e})
            }
    ...
    updateAnchor: t => {
        if (t !== window.location.hash) {
            ...
            window.history.replaceState({url: location.href, title: e}, e, t)
        }
    }
};