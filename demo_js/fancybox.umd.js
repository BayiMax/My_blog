...
!function (t, e) {
    ...
    var D = {Navigation: F, Dots: R, Sync: N}, B = {
        slides: [],
        preload: 0,
        slidesPerPage: "auto",
        initialPage: null,
    ...
    var H = !("undefined" == typeof window || !window.document || !window.document.createElement), j = null,
            ...
            key: "onKeydown", value: function (t) {
                if (i.getInstance().id === this.id) {
                    ...
                    if (n && !t.ctrlKey && !t.altKey && !t.shiftKey) {
                        var o = t.composedPath()[0], a = document.activeElement && document.activeElement.classList,
