...
(function () {
    ...
    var data = {
        "resource": {
            ...
            "macros": [{"function": "__e"}, {"function": "__c", "vtp_value": "google.cn"}, {
                "function": "__c",
                "vtp_value": 1
            }, {"vtp_signal": 0, "function": "__c", "vtp_value": 0}],
            "tags": [{
                "function": "__gct",
                "vtp_trackingId": "G-2P0LMHZNDD",
                ...
                "vtp_instanceDestinationId": "G-2P0LMHZNDD",
                "tag_id": 3
            }, {
        ...
        ,
        "infra": ["__ccd_em_video", "__ccd_em_page_view", "__ogt_google_signals", "__ccd_em_site_search", "__set_product_settings", "__ccd_em_scroll", "__ccd_em_outbound_click", "__ccd_em_download", "__ccd_ga_regscope", "__ccd_conversion_marking"]
 ...
 jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    var zc = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/, Ac = function (a) {
        ...
        for (d in a) if (Bc(a, d)) {
            var e = a[d];
            "array" == Ac(e) ? ("array" != Ac(c[d]) && (c[d] = []), c[d] = J(e, c[d])) : Cc(e) ? (Cc(c[d]) || (c[d] = {}), c[d] = J(e, c[d])) : c[d] = e
        }
        return c
    };
    var Ec = function (a, b, c) {
        var d = [], e = [], f = function (h, l) {
            ...
            if (h instanceof wc && u) return h.Ya;
            switch (typeof h) {
                case "boolean":
                case "number":
                case "string":
    ...
    var se = [], te = [], ue = [], ve = [], we = [], xe = {}, ye, Ae, Ce = function () {
        ...
        var e = xe[c], f = {}, g;
        for (g in a) a.hasOwnProperty(g) && 0 === g.indexOf("vtp_") && (e && d && d.Qh && d.Qh(a[g]), f[void 0 !== e ? g : g.substr(4)] = a[g]);
        ...
        if (Ea(a)) {
            ...
            switch (a[0]) {
                ...
                case "escape":
                    d = Ge(a[1], b, c);
                    if (Ae && Ea(a[1]) && "macro" === a[1][0] && Ae.hk(a)) return Ae.Ck(d);
                    d = String(d);
                    for (var t = 2; t < a.length; t++) Xd[a[t]] && (d = Xd[a[t]](d));
                    return d;
                case "tag":
                    var u = a[1];
                    if (!ve[u]) throw Error("Unable to resolve tag reference " + u + ".");
                    return d = {Vh: a[2], index: u};
                case "zb":
                    var v = {arg0: a[2], arg1: a[3], ignore_case: a[5]};
                    v["function"] = a[1];
                    var w = Ie(v, b, c), x = !!a[4];
    ...
    bf.fl = Pa('');
    bf.Jj = Pa('');
    var cf = af, df = bf.Jj, ef = bf.fl;
    var ff = function (a, b) {
        var c = String(a);
        return c
    };
    var mf = function (a) {
        var b = {}, c = 0, d = gf ? 27 : 10;
        Ma(a, function (f, g) {
            if (void 0 !== g) if (g = ff(g, 100), hf.hasOwnProperty(f)) b[hf[f]] = jf(g); else if (kf.hasOwnProperty(f)) {
                var h = kf[f], l = jf(g);
                b.hasOwnProperty(h) || (b[h] = l)
            } else if ("category" === f) for (var n = jf(g).split("/", 5), p = 0; p < n.length; p++) {
                var q = lf[p], r = n[p];
    ...
    var qf = function (a, b) {
        ...
        var d = [];
        a.Ha && d.push(a.Ha);
        for (var e = {}, f = 0; f < c.length; f++) Ma(c[f].Tb, function (t, u) {
        ...
        qf(g, d);
        b && d.push("_s=" + b);
        for (var h = d.join("&"), l = [], n = {}, p = 0; p < c.length; n = {Qd: n.Qd}, p++) {
            var q = [];
            n.Qd = {};
    ...
    function Df(a, b) {
        ...
        Ff = {Fn: "function", DustMap: "Object", List: "Array"}, K = function (a, b, c) {
    ...
    var Xf = function () {
        ...
        var a = new jb;
        a.set("containerId", 'G-2P0LMHZNDD');
        a.set("version", '1');
    ...
    var rg = function (a) {
            ...
            if (m.crypto && m.crypto.subtle) {
                if (Eg.test(a)) return Promise.resolve(a);
                try {
                    var b = Fg(a);
            ...
            return b
        }, wg = /[0-9`~!@#$%^&*()_\-+=:;<>,.?|/\\[\]]/g, zg = /^\S+@\S+\.\S+$/, xg = /^\+\d{10,15}$/, sg = /[.~]/g,
        Gg = /^[0-9A-Za-z_-]{43}$/, Eg = /^[0-9A-Fa-f]{64}$/, Hg = {},
        Ig = (Hg.email = "em", Hg.phone_number = "pn", Hg.first_name = "fn", Hg.last_name = "ln", Hg.street = "sa", Hg.city = "ct", Hg.region = "rg", Hg.country = "co", Hg.postal_code = "pc", Hg.error_code = "ec", Hg),
        Jg = {},
        Kg = (Jg.email = "sha256_email_address", Jg.phone_number = "sha256_phone_number", Jg.first_name = "sha256_first_name", Jg.last_name =
            "sha256_last_name", Jg.street = "sha256_street", Jg), Lg = function (a, b) {
            function c(t, u, v, w) {
                var x = rg(t);
                "" !== x && (Eg.test(x) ? l.push({name: u, value: x, index: w}) : l.push({name: u, value: v(x), index: w}))
            }
            ...
            Lg(a, function (c) {
                for (var d = ["tv.1"], e = 0, f = 0; f < c.length; ++f) {
                    var g = c[f].name, h = c[f].value, l = c[f].index, n = Ig[g];
                    n && h && (-1 === Bg.indexOf(g) || /^e\d+$/.test(h) || Gg.test(h) || Eg.test(h)) && (void 0 !== l && (n += l), d.push(n + "." + h), e++)
                }
    ...
    Og[44] = !0;
    a: {
        for (var Pg, Qg, Rg = 0; Pg === Qg;) if (Pg = Math.floor(2 * Math.random()), Qg = Math.floor(2 * Math.random()), Rg++, 20 < Rg) break a;
        Pg ? Og[46] = !0 : Og[47] = !0;
    }
    Og[54] = !0;
    Og[57] = !0;
    ...
    var S = {
        ...
        Tg = (Sg[S.g.fa] = 1, Sg[S.g.Jc] = 1, Sg[S.g.bc] = 1, Sg[S.g.ia] = 1, Sg[S.g.nb] = 1, Sg[S.g.Pa] = 1, Sg[S.g.ob] = 1, Sg[S.g.Qc] = 1, Sg[S.g.cf] = 1, Sg[S.g.Za] = 1, Sg[S.g.Hb] = 1, Sg[S.g.Sc] = 1, Sg[S.g.ja] = 1, Sg[S.g.df] =
            1, Sg[S.g.fc] = 1, Sg[S.g.de] = 1, Sg[S.g.ee] = 1, Sg[S.g.fe] = 1, Sg[S.g.Xc] = 1, Sg[S.g.yb] = 1, Sg[S.g.je] = 1, Sg[S.g.ke] = 1, Sg[S.g.jf] = 1, Sg[S.g.ne] = 1, Sg[S.g.za] = 1, Sg[S.g.nf] = 1, Sg[S.g.oe] = 1, Sg[S.g.zb] = 1, Sg[S.g.Fa] = 1, Sg[S.g.Kb] = 1, Sg[S.g.ad] = 1, Sg[S.g.pf] = 1, Sg[S.g.oc] = 1, Sg[S.g.wa] = 1, Sg[S.g.bd] = 1, Sg[S.g.yf] = 1, Sg[S.g.Ta] = 1, Sg);
    R(65) && (Tg[S.g.fd] = 1);
    var Ug = Object.freeze(Tg);
    Object.freeze([S.g.Ra, S.g.Sa, S.g.nc, S.g.Qa, S.g.lh, S.g.Aa, S.g.ff, S.g.Oi]);
    var Vg = {},
        Wg = Object.freeze((Vg[S.g.Di] = 1, Vg[S.g.Ei] = 1, Vg[S.g.Fi] = 1, Vg[S.g.Gi] = 1, Vg[S.g.Hi] = 1, Vg[S.g.Ii] = 1, Vg[S.g.Ji] = 1, Vg[S.g.Ki] = 1, Vg[S.g.Li] = 1, Vg[S.g.Ze] = 1, Vg)),
        Xg = {},
        Yg = Object.freeze((Xg[S.g.Fg] = 1, Xg[S.g.Gg] = 1, Xg[S.g.Ec] = 1, Xg[S.g.Fc] = 1, Xg[S.g.Hg] = 1, Xg[S.g.Yb] = 1, Xg[S.g.Gc] = 1, Xg[S.g.Fb] = 1, Xg[S.g.Zb] = 1, Xg[S.g.Gb] = 1, Xg[S.g.Ja] = 1, Xg[S.g.Hc] = 1, Xg[S.g.Oa] = 1, Xg[S.g.Ig] = 1, Xg)),
        Zg = Object.freeze([S.g.fa, S.g.bc, S.g.Hb]), $g = Object.freeze([].concat(Zg)),
        ah = Object.freeze([S.g.Pa, S.g.ee, S.g.ad, S.g.pf, S.g.ce]),
        bh = Object.freeze([].concat(ah)), ch = {}, dh = (ch[S.g.J] = "1", ch[S.g.Z] = "2", ch), eh = {},
        fh = Object.freeze((eh[S.g.fa] = 1, eh[S.g.Jc] = 1, eh[S.g.Ea] = 1, eh[S.g.kb] = 1, eh[S.g.Vd] = 1, eh[S.g.Kc] = 1, eh[S.g.Lc] = 1, eh[S.g.Mc] = 1, eh[S.g.ia] = 1, eh[S.g.Nc] = 1, eh[S.g.La] = 1, eh[S.g.ya] = 1, eh[S.g.nb] = 1, eh[S.g.Pa] = 1, eh[S.g.ob] = 1, eh[S.g.Za] = 1, eh[S.g.va] = 1, eh[S.g.Rc] = 1, eh[S.g.ja] = 1, eh[S.g.Kg] = 1, eh[S.g.Vc] = 1, eh[S.g.Wc] = 1, eh[S.g.ff] = 1, eh[S.g.fe] = 1, eh[S.g.ne] = 1, eh[S.g.Qa] = 1, eh[S.g.mc] = 1, eh[S.g.Ra] = 1, eh[S.g.Sa] = 1, eh[S.g.gh] = 1, eh[S.g.hh] = 1,
            eh[S.g.ih] = 1, eh[S.g.jh] = 1, eh[S.g.zb] = 1, eh[S.g.Fa] = 1, eh[S.g.Kb] = 1, eh[S.g.oc] = 1, eh[S.g.Ma] = 1, eh[S.g.wa] = 1, eh[S.g.bd] = 1, eh[S.g.qb] = 1, eh[S.g.ka] = 1, eh[S.g.Aa] = 1, eh[S.g.ra] = 1, eh));
    Object.freeze(S.g);
    var gh = {}, hh = m.google_tag_manager = m.google_tag_manager || {}, ih = Math.random();
    gh.ed = "bu0";
    gh.Ef = Number("0") || 0;
    gh.ma = "dataLayer";
    gh.Bi = "ChAIgOLgnAYQ5oKGgcjgjtEWEiUAr3Sn3PiiAvyPBbMJqDZPpUyDSxVlFTXv2KPOU9qszO9dPVIUGgLiBQ\x3d\x3d";
    var jh = {
        __cl: !0,
        __ecl: !0,
        __ehl: !0,
        ...
        __tl: !0,
        __ytl: !0
    }, kh = {__paused: !0, __tg: !0}, lh;
    for (lh in jh) jh.hasOwnProperty(lh) && (kh[lh] = !0);
    var mh = Pa("true"), nh = Pa(""), oh, ph = !1;
    ph = !0;
    oh = ph;
    var qh, rh = !1;
    qh = rh;
    ...
    var wh = "" + gh.Td + (oh ? "/gtag/js" : "/gtm.js"), xh = null, yh = null, zh = {}, Ah = {}, Bh = {},
        Ch = function () {
            var a = hh.sequence || 1;
            hh.sequence = a + 1;
            return a
    ...
    var Dh = "";
    gh.xe = Dh;
    var Lh = new Ka, Mh = {}, Nh = {}, Qh = {
        name: gh.ma, set: function (a, b) {
            J(bb(a, b), Mh);
            Oh()
        }, get: function (a) {
            return Ph(a, 2)
        ...
        Nh.hasOwnProperty(a) || (Lh.set(a, b), J(bb(a, b), Mh), Oh())
    }, Th = function () {
    ...
    var ai = function () {
        ...
        var b = ai(), c = b.height, d = b.width, e = a.getBoundingClientRect(), f = e.bottom - e.top,
            g = e.right - e.left;
    ...
    var ci = [], di = !(!m.IntersectionObserver || !m.IntersectionObserverEntry), ei = function (a, b, c) {
        for (var d = new m.IntersectionObserver(a, {threshold: c}), e = 0; e < b.length; e++) d.observe(b[e]);
        for (var f = 0; f < ci.length; f++) if (!ci[f]) return ci[f] = d, f;
        return ci.push(d) - 1
    }, fi = function (a, b, c) {
        function d(h, l) {
        ...
        if (di) {
            ...
            return ei(function (f) {
                e = !0;
                for (var g = {zc: 0}; g.zc < f.length; g = {zc: g.zc}, g.zc++) I(function (h) {
                    return function () {
                        return a(f[h.zc])
                    }
                }(g))
        ...
        di ? 0 <= a && a < ci.length && ci[a] && (ci[a].disconnect(), ci[a] = void 0) : m.clearInterval(a)
    };
    var ii = /:[0-9]+$/, ji = function (a, b, c, d) {
        ...
        if ("protocol" === b || "port" === b) a.protocol = ki(a.protocol) || ki(m.location.protocol);
        "port" === b ? a.port = String(Number(a.hostname ? a.port :
            m.location.port) || ("http" === a.protocol ? 80 : "https" === a.protocol ? 443 : "")) : "host" === b && (a.hostname = (a.hostname || m.location.hostname).replace(ii, "").toLowerCase());
        return li(a, b, c, d, e)
        ...
        var d = "gclid dclid gbraid wbraid gclaw gcldc gclha gclgf gclgb _gl".split(" "), e = oi(a),
    ...
    qi.xi = "true";
    var yi = function (a) {
            if ("false" === qi.xi || !wi) return !1;
            if (xi) return !0;
            var b = Yh("AW-" + a);
            return !!b && !!b.preAutoPii
        }, zi = /[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}/i, Ai = /@(gmail|googlemail)\./i, ui = /support|noreply/i,
        Bi = "SCRIPT STYLE IMG SVG PATH BR NOSCRIPT TEXTAREA".split(" "), Ci = ["BR"], Di = {}, Ei = function (a) {
            a = a || {Ob: !0, Pb: !0};
            ...
            if (h) {
                for (var l = h.querySelectorAll("*"), n = 0; n < l.length && 1E4 > n; n++) {
                    ...
                    if (!(0 <= Bi.indexOf(p.tagName.toUpperCase())) && p.children instanceof HTMLCollection) {
                        for (var q = !1, r = 0; r < p.childElementCount && 1E4 > r; r++) if (!(0 <= Ci.indexOf(p.children[r].tagName.toUpperCase()))) {
                            q = !0;
                            break
                        }
                        q || g.push(p)
            ...
            if (a.rb && a.rb.email) {
                for (var x =
                    t.elements, y = [], A = 0; A < x.length; A++) {
                    var B = x[A], C = B.textContent;
            ...
            var ca =
                [];
            !a.sg && w && (v = [w]);
            for (var V = 0; V < v.length; V++) ca.push(si(v[V], a.Ob, a.Pb));
            var Fa = {elements: ca.slice(0, 10), Pe: si(w, a.Ob, a.Pb), status: u};
            Di[b] = {timestamp: Ta(), result: Fa};
            return Fa
        }, Fi = function (a) {
    ...
    var Gi = function (a, b, c) {
        ...
        if ("js_variable" === d) {
            ...
            for (var g = e.split(","), h = 0; h < g.length; h++) {
                var l = g[h].trim();
                if (l) {
                    if (0 === l.indexOf("dataLayer.")) f = Ph(l.substring(10)); else {
                        var n = l.split(".");
                        f = m[n.shift()];
        ...
        if (a) {
            if ("selectors" === a.mode || Cc(a.selectors)) return Hi(a.selectors);
        ...
        if (void 0 != b) {
            ...
            if ("" === d || p === e || (p === d ? n !== e : !p && !n)) {
                ...
                q && m.setTimeout(function () {
                    h[a] === r && r.quiet && (r.quiet = !1, fj(a), ej(), vb("TAGGING",
                        2))
                }, f)
            }
        }
    ...
    function cj(a, b) {
        ...
        c.usedUpdate = !0;
        if (void 0 != b) {
            var d = gj(c, a), e = c.entries, f = e[a] = e[a] || {};
            f.update = "granted" === b;
            var g = gj(c, a);
            f.quiet ? (f.quiet = !1, fj(a)) : g !== d && fj(a)
        }
    }
    ...
    function ej(a, b) {
        for (var c = 0; c < $i.length; ++c) {
            ...
            if (d.ei) {
                d.ei = !1;
                try {
                    d.Oj({consentEventId: a, consentPriorityId: b})
                } catch (e) {
                }
            }
        }
    ...
    var hj = function (a) {
        ...
        function c() {
            for (var e = 0; e < b.length; e++) if (!jj(b[e])) return !0;
            return !1
        }
    ...
    var tj = [S.g.J, S.g.Z], uj = function (a) {
        var b = a[S.g.We];
        b && N(40);
        var c = a[S.g.Xe];
        c && N(41);
    ...
    var Qj = function (a, b, c, d) {
        ...
        if (!Gj(c.Db)) return 2;
        var g;
        void 0 == b ? g = a + "=deleted; expires=" + (new Date(0)).toUTCString() : (c.encode && (b = encodeURIComponent(b)), b = Nj(b), g = a + "=" + b);
        var h = {};
        g = e(g, "path", c.path);
        var l;
        ...
        if (n && "auto" === n.toLowerCase()) {
            for (var p = Oj(), q = void 0, r = !1, t = 0; t < p.length; ++t) {
                ...
                r = !0;
                if (!Pj(u, c.path) && Mj(v, a, b, c.Db)) return 0
            }
            if (q && !r) throw q;
            return 1
        }
    ...
    function Jj(a, b, c) {
        for (var d = [], e = Ij(a, void 0, void 0, c), f = 0; f < e.length; f++) {
            ...
            if (!b || -1 !== b.indexOf(h)) {
                var l = g.shift();
                l && (l = l.split("-"), d.push({id: g.join("."), Fe: 1 * l[0] || 1, Ed: 1 * l[1] || 1}))
            }
        }
        return d
    }
    ...
    var Nj = function (a) {
        ...
        return a
    }, Sj = /^(www\.)?google(\.com?)?(\.[a-z]{2})?$/, Tj = /(^|\.)doubleclick\.net$/i, Pj = function (a, b) {
    ...
    var Ve = {N: "G-2P0LMHZNDD", Xb: "83427295"}, ck = {ci: "G-2P0LMHZNDD", di: "G-2P0LMHZNDD"};
    Ve.Cf = Pa("");
    var dk = function () {
    ...
    function gk() {
        var a = hh.tidr;
        a || (a = new fk, hh.tidr = a);
        return a
    }

    var lk = {"": "n", UA: "u", AW: "a", DC: "d", G: "e", GF: "f", GT: "t", HA: "h", MC: "m", GTM: "g", OPT: "o"},
        mk = {UA: 1, AW: 2, DC: 3, G: 4, GF: 5, GT: 12, GTM: 14, HA: 6, MC: 7}, nk = function (a) {
            ...
            if (R(45)) {
                ...
                d.Mk = gh.ed;
                d.rk = Ve.Cf ? 2 : 1;
                oh ? (d.Se = mk[c], d.Se || (d.Se = 0)) : d.Se = uh ? 13 : 10;
                sh ? d.eg = 1 : bk() ? d.eg = 2 : d.eg = 3;
                var e;
                var f = d.Se, g = d.eg;
                void 0 === f ? e = "" : (g || (g = 0), e = "" + Df(1, 1) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[f << 2 | g]);
                var h = d.ql, l = 4 + e + (h ? "" + Df(2,
                    1) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[h] : ""), n, p = d.Mk;
            ...
            var y = lk[c] || "i", A = a && "GTM" === c ? b[1] : "OPT" ===
            c ? b[1] : "", B = "w";
            oh && (B = bk() ? "s" : "o");
            qh ? ("w" === B && (B = "x"), "o" === B && (B = "q")) : sh ? ("w" === B && (B = "y"), "o" === B && (B = "r")) : uh && (B = "z");
    ...
    var tk = function (a, b, c, d) {
        ...
        var c = a.search(uk), d = tk(a, 0, b, c);
        if (0 > d) return null;
        var e = a.indexOf("&", d);
        if (0 > e || e > c) e = c;
        d += b.length + 1;
        return decodeURIComponent(a.slice(d, -1 !== e ? e : 0).replace(/\+/g, " "))
    }, wk = /[?&]($|#)/, xk = function (a, b, c) {
        for (var d, e = a.search(uk), f = 0, g, h = []; 0 <= (g = tk(a, f, b, e));) h.push(a.substring(f,
    ...
    Hk.prototype.addEventListener = function (a) {
        var b = this, c = {internalBlockOnErrors: this.F}, d = Ej(function () {
            return a(c)
        }), e = 0;
        ...
        var f = function (g, h) {
            clearTimeout(e);
            g ? (c = g, c.internalErrorState = Gk(c), c.internalBlockOnErrors = b.F, h && 0 === c.internalErrorState || (c.tcString = "tcunavailable", h || (c.internalErrorState = 3))) : (c.tcString = "tcunavailable", c.internalErrorState = 3);
            a(c)
        };
        try {
    ...
    var Kk = function (a, b, c) {
        ...
        } else l = !0; else l = 1 === h ? a.purpose && a.vendor ? Jk(a.purpose.legitimateInterests,
            b) && Jk(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0 : !0;
        return l
    }, Jk = function (a, b) {
        return !(!a || !a[b])
    }, Ik = function (a, b, c, d) {
        ...
        return "error" === a.cmpStatus || 0 !== a.internalErrorState ? a.internalBlockOnErrors ?
            (Ek({e: String(a.internalErrorState)}), !1) : !0 : "loaded" !== a.cmpStatus || "tcloaded" !== a.eventStatus && "useractioncomplete" !== a.eventStatus ? !1 : !0
    };
    var Ok = !0;
    Ok = !1;
    var Pk = {1: 0, 3: 0, 4: 0, 7: 3, 9: 3, 10: 3}, Qk = ok("", 550), Rk = ok("", 500);
        ...
        if (!0 === m.gtag_enable_tcf_support && !a.active && ("function" === typeof m.__tcfapi || "function" === typeof b.B.__tcfapi || null != Lk(b))) {
            ...
            try {
                b.addEventListener(function (d) {
                    ...
                    if (0 !== d.internalErrorState) Uk(a), Vk(a); else {
                        var e;
                        a.gdprApplies = d.gdprApplies;
                        if (!1 === d.gdprApplies) e = Wk(), b.removeEventListener(d); else if ("tcloaded" ===
                            d.eventStatus || "useractioncomplete" === d.eventStatus || "cmpuishown" === d.eventStatus) {
                            var f = {}, g;
                            for (g in Pk) if (Pk.hasOwnProperty(g)) if ("1" === g) {
                                var h, l = d, n = !0;
                                n = void 0 === n ? !1 : n;
                                ...
                                f["1"] = h
                            } else f[g] = Kk(d, g, Pk[g]);
                            e = f
                        }
                        e && (a.tcString = d.tcString || "tcempty", a.Hd = e, Vk(a))
                    }
                })
            } catch (d) {
                c && (clearTimeout(c), c = null), Uk(a), Vk(a)
            }
        }
    };
    ...
    function Tk() {
        var a = {}, b = (a.ad_storage = "denied", a.wait_for_update = Qk, a);
        uj(b)
    }

    function Wk() {
        var a = {}, b;
        for (b in Pk) Pk.hasOwnProperty(b) && (a[b] = !0);
        return a
    }

    function Vk(a) {
        var b = {}, c = (b.ad_storage = a.Hd["1"] ? "granted" : "denied", b);
        vj(c, {eventId: 0}, {gdprApplies: a ? a.gdprApplies : void 0, tcString: Yk()})
    }
    ...
    var Yk = function () {
        ...
        if (!Pk.hasOwnProperty(String(a))) return !0;
        var b = Sk();
        return b.active && b.Hd ? !!b.Hd[String(a)] : !0
    };
    var al = ["L", "S", "Y"], bl = ["S", "E"], cl = {sampleRate: "0.005000", vi: "", ui: Number("5"), si: Number("")},
        dl = 0 <= G.location.search.indexOf("?gtm_latency=") || 0 <= G.location.search.indexOf("&gtm_latency="), el;
    if (!(el = dl)) {
        var fl = Math.random(), gl = cl.sampleRate;
        el = fl < gl
    }
    var hl = el, il = "https://www.googletagmanager.com/a?id=" + Ve.N + "&cv=1",
        jl = {label: Ve.N + " Container", children: [{label: "Initialization", children: []}]};
    ...
    var nl = {}, ol = "", Fl = "", Gl = "", Hl = "", Il = [], Jl = "", Kl = {}, Ll = !1, Ml = {}, Nl = {}, Ol = {},
        Pl = "", Ql = void 0, Rl = {}, Sl = {}, Tl = void 0, Ul = 5;
    0 < cl.ui && (Ul = cl.ui);
    var Vl = function (a, b) {
    ...
    function Yl(a, b) {
        var c = Ql;
        if (void 0 === c) return "";
        var d = xb("GTM"), e = xb("TAGGING"), f = xb("HEALTH"), g = ll, h = nl[c] ? "" : "&es=1", l = Rl[c], n = Zl(c),
            p = $l(), q = ol, r = Fl, t = Pl, u = am(a), v = Gl, w = Hl, x = bm(a, b), y;
        return [g, h, l, n, d ? "&u=" + d : "", e ? "&ut=" + e : "", f ? "&h=" + f : "", p, q, r, t, u, v, w, x, y, Jl ? "&dl=" + encodeURIComponent(Jl) : "", 0 < Il.length ? "&tdp=" + Il.join(".") :
            "", gh.Ef ? "&x=" + gh.Ef : "", "&z=0"].join("")
    }

    function dm(a) {
        Tl && (m.clearTimeout(Tl), Tl = void 0);
        if (void 0 !== Ql && (!nl[Ql] || ol || Fl || em(a))) if (void 0 === fm[Ql] && (Sl[Ql] || Vl.ik() || 0 >= Wl--)) N(1), Sl[Ql] = !0; else {
            void 0 === fm[Ql] && Vl.Gk();
            var b = Yl(!0, a);
            a ? kc(b) : dc(b);
    ...
    var um = function (a, b, c) {
        ...
        }, wm = ["S", "P", "C", "Z"], xm = {}, ym = (xm[1] = 5, xm[2] = 5, xm[3] = 5, xm), zm = {}, fm = {}, cm = void 0,
        Am = function (a, b) {
            var c = !1;
            if (!hl || fm[a] || 0 === ym[b]) return !1;
            --ym[b];
            fm[a] = b;
            c = !0;
            return c
    ...
    var Cm = function () {
        if (hl) {
            ...
            ec(m, "pagehide", function () {
                Ql && fm[Ql] && dm(!0);
                for (var a in zm) zm.hasOwnProperty(a) && (Ql = Number(a), dm(!0));
            });
        }
    };
    var Dm = function (a) {
    ...
    var Em = {}, Fm = null, Gm = function (a) {
        ...
        for (var r = Em[f], t = Array(Math.floor(b.length / 3)), u = r[64] || "", v = 0, w = 0; v < b.length - 2; v += 3) {
            var x = b[v],
                y = b[v + 1], A = b[v + 2], B = r[x >> 2], C = r[(x & 3) << 4 | y >> 4], E = r[(y & 15) << 2 | A >> 6],
                H = r[A & 63];
            t[w++] = "" + B + C + E + H
        }
        var D = 0, L = u;
        ...
        if (d) c(d); else {
            ...
            if (e) {
                ...
                var f = m.setTimeout(function () {
                    c.Ad || (c.Ad = !0, N(106), c(null, Error("Timeout")))
                }, b);
                e.then(function (g) {
                    c.Ad || (c.Ad = !0, N(104), m.clearTimeout(f), c(g))
                }).catch(function (g) {
                    c.Ad || (c.Ad = !0, N(105), m.clearTimeout(f), c(null, g))
                })
            } else c(null)
        }
    }, Rm = function (a, b, c) {
        c = void 0 === c ? !1 : c;
        a && (b.C[S.g.rf] = a.architecture, b.C[S.g.sf] = a.bitness, a.fullVersionList && (b.C[S.g.tf] = a.fullVersionList.map(function (d) {
            return encodeURIComponent(d.brand || "") + ";" + encodeURIComponent(d.version ||
                "")
        }).join("|")), c && (b.C[S.g.ph] = a.mobile ? "1" : "0"), b.C[S.g.uf] = a.model, b.C[S.g.vf] = a.platform, b.C[S.g.wf] = a.platformVersion, b.C[S.g.xf] = a.wow64 ? "1" : "0")
    };
    ...
    };var Tm = ["1"], Um = {}, Vm = {}, Xm = function (a) {
        return Um[Wm(a)]
    }, $m = function (a, b) {
        b = void 0 === b ? !0 : b;
        var c = Wm(a.prefix);
        if (!Um[c] && !Ym(c, a.path, a.domain) && b) {
            var d = Wm(a.prefix), e = Vj();
            if (0 === Zm(d, e, a)) {
    ...
    function Ym(a, b, c) {
        ...
        if (!d) return !1;
        var e = d.split(".");
        5 === e.length ? (Um[a] = e.slice(0, 2).join("."), Vm[a] = {
            id: e.slice(2, 4).join("."),
            ai: Number(e[4]) || 0
        }) : 3 === e.length ? Vm[a] = {id: e.slice(0, 2).join("."), ai: Number(e[2]) || 0} : Um[a] = d;
        return !0
    }
    ...
    var en = function () {
        var a = bn, b = cn, c = dn(), d = function (g) {
    ...
    function dn() {
        ...
        return b
    };var hn = /(.*?)\*(.*?)\*(.*)/, jn = /^https?:\/\/([^\/]*?)\.?cdn\.ampproject\.org\/?(.*)/,
        kn = /^(?:www\.|m\.|amp\.)+/, ln = /([^?#]+)(\?[^#]*)?(#.*)?/;
    ...
    function nn(a, b) {
        ...
        an = d;
        for (var l = 4294967295, n = 0; n < c.length; n++) l = l >>> 8 ^ an[(l ^ c.charCodeAt(n)) & 255];
        return ((l ^ -1) >>> 0).toString(36)
    }

    function pn() {
        return function (a) {
            var b = oi(m.location.href), c = b.search.replace("?", ""), d = ji(c, "_gl", !1, !0) || "";
            a.query = qn(d) || {};
    ...
    var sn = function (a, b) {
        ...
        var c = ln.exec(a);
        if (!c) return "";
        var d = c[1], e = rn(b, (c[2] || "").slice(1)), f = rn(b, (c[3] || "").slice(1));
        e.length && (e = "?" + e);
        f.length && (f = "#" + f);
        return "" + d + e + f
    }, tn = function (a) {
    ...
    function un(a, b) {
        if (a) {
            ...
            if (g && "1" === g[1]) {
                var h = g[3], l;
                a: {
                    for (var n = g[2], p = 0; p < b; ++p) if (n === nn(h, p)) {
                        l = !0;
                        break a
                    }
                    l = !1
    ...
    function wn(a, b) {
        var c = "FORM" === (a.tagName || "").toUpperCase(), d = gn(b, 1, c), e = gn(b, 2, c), f = gn(b, 3, c);
        if (Xa(d)) {
            var g = on(d);
    ...
    var zn = function (a, b, c, d) {
        ...
        var a = G.location.hostname, b = jn.exec(G.referrer);
        if (!b) return !1;
        var c = b[2], d = b[1], e = "";
        if (c) {
            var f = c.split("/"), g = f[1];
    ...
    var En = function (a) {
        for (var b = [], c = G.cookie.split(";"), d = new RegExp("^\\s*" + (a || "_gac") + "_(UA-\\d+-\\d+)=\\s*(.+?)\\s*$"), e = 0; e < c.length; e++) {
            var f = c[e].match(d);
            f && b.push({vg: f[1], value: f[2], timestamp: Number(f[2].split(".")[1]) || 0})
        }
        b.sort(function (g, h) {
    ...
    function Fn(a, b) {
        ...
        return d
    };var Gn = /^\w+$/, Hn = /^[\w-]+$/, In = {aw: "_aw", dc: "_dc", gf: "_gf", ha: "_ha", gp: "_gp", gb: "_gb"},
        Jn = function () {
            if (!Zi().h() || !kj()) return !0;
            var a = hj("ad_storage");
            return null == a ? !0 : !!a
            ...
            for (var d = {}, e = 0; e < c.length; d =
                ...
                if (null != f) {
                    ...
                    p ? (p.timestamp = Math.max(p.timestamp, l), p.labels = On(p.labels, n || [])) : b.push({
                        version: h,
                        la: d.Od,
                        timestamp: l,
                        labels: n
    ...
    var Sn = function () {
        var a = oi(m.location.href), b = mi(a, "query", !1, void 0, "gclid"), c = mi(a, "query", !1, void 0, "gclsrc"),
        ...
        e.gclsrc = b;
        e.dclid = c;
        void 0 !== d && Hn.test(d) && (e.gbraid = d, f(d, "gb"));
        if (void 0 !== a && a.match(Hn)) switch (b) {
            case void 0:
                f(a,
                    "aw");
                break;
    ...
    function Tn(a, b, c, d, e) {
        ...
        if ((void 0 == Dn.enable_gbraid_cookie_write ? 0 : Dn.enable_gbraid_cookie_write) && !l && a.gb) {
            var q = a.gb[0], r = Vn("gb",
                g), t = !1;
            if (!b) for (var u = Ln(r), v = 0; v < u.length; v++) u[v].la === q && u[v].labels && 0 < u[v].labels.length && (t = !0);
            t || f("gb", p(q))
        }
    }
    ...
    var Xn = function (a, b) {
            ...
            for (var d = Qn(b.prefix), e = 0; e < a.length; ++e) {
                ...
                if (void 0 !== In[f]) {
                    ...
                    if (h) {
                        ...
                        b: {
                            var p = l;
                            if (Fj(m)) for (var q = Ij(g, G.cookie, void 0, "ad_storage"), r = 0; r < q.length; ++r) if (Wn(q[r]) > p) {
                                n = !0;
                                break b
                            }
                            n = !1
        ...
        return 0 !== Yn(a.split(".")).length ? 1E3 * (Number(a.split(".")[1]) ||
            0) : 0
    };
    ...
    var Zn = function (a, b, c, d, e) {
        ...
        if (Fj(m)) {
            for (var c = Qn(b.prefix), d = {}, e = 0; e < a.length; e++) In[a[e]] && (d[a[e]] = In[a[e]]);
            Kn(function () {
                Ma(d, function (f, g) {
                    ...
                    if (h.length) {
                        var l = h[0], n = Wn(l), p = 0 !== Yn(l.split(".")).length ? l.split(".").slice(3) : [], q = {},
                            r;
    ...
    var bo = function (a) {
        ...
        if (1 !== e[0]) {
            var h = f[0], l = f[0].timestamp, n = [h.version, Math.round(l /
                1E3), h.la].concat(h.labels || [], [b]).join("."), p = Sm(c, l, !0);
            p.Db = "ad_storage";
            Rj(a, n, p)
        }
        return e
    ...
    function eo(a, b) {
        var c = Qn(b), d = Vn(a, c);
        if (!d) return 0;
        for (var e = Ln(d), f = 0, g = 0; g < e.length; g++) f = Math.max(f, e[g].timestamp);
        return f
    }
    ...
    var lo = /[A-Z]+/, mo = /\s/, no = function (a) {
        if (k(a)) {
            ...
            if (!(0 > b)) {
                ...
                if (lo.test(c)) {
                    for (var d = a.substring(b + 1).split("/"), e = 0; e < d.length; e++) if (!d[e] || mo.test(d[e]) && ("AW" !== c || 1 !== e)) return;
    ...
    function Go(a) {
        ...
        var b = Ho[a.target.V];
        if (!a.K && b) for (var c = Go(a), d = 0; d < b.length; ++d) {
            try {
                b[d](c)
            } catch (e) {
                a.K = !0
    ...
    var $o = function (a, b, c, d, e, f, g, h, l, n, p, q) {
            ...
            b(a.B);
            b(a.F);
            if (hl) for (var d = Object.keys(a.T), e = 0; e < d.length; e++) {
                var f = d[e];
        ...
        dp = function (a) {
            var b = [S.g.Oc, S.g.Wd, S.g.Xd, S.g.Yd, S.g.Zd, S.g.ae, S.g.be], c = {}, d = !1, e = function (h) {
    ...
    function wp() {
        if (up("join-ad-interest-group") && Ca(Ub.joinAdInterestGroup)) return !0;
        vp || (zk(''), vp = !0);
    ...
    function yp() {
        ...
        Ap = /^~?[\w-]+(?:\.~?[\w-]+)*$/, Bp = /^\d+\.fls\.doubleclick\.net$/, Cp = /;gac=([^;?]+)/,
        Dp = /;gacgb=([^;?]+)/, Ep = /;gclaw=([^;?]+)/, Fp = /;gclgb=([^;?]+)/;
    ...
    var Hp = function (a, b, c) {
        ...
        return {Rj: f ? e.join(";") : "", Qj: Gp(d, Dp)}
    };

    function Ip(a, b, c) {
        if (Bp.test(G.location.host)) {
            var d = G.location.href.match(c);
            if (d && 2 == d.length && d[1].match(Ap)) return [{la: d[1]}]
        } else return Ln((a || "_gcl") + b);
        return []
    }
    ...
    var wq = function (a, b) {
        var c = vk(a, "fmt");
        if (b) {
            var d = vk(a, "random"), e = vk(a, "label") || "";
            if (!d) return !1;
    ...
    function Uq() {
        ...
        if (!Vq() && !ik(a)) {
            var e = c ? "/gtag/js" : "/gtm.js", f = "?id=" + encodeURIComponent(a) + "&l=" + gh.ma,
                g = 0 === a.indexOf("GTM-");
            g || (f += "&cx=c");
            var h = Uq();
            h && (f += "&sign=" + gh.xe);
            ...
            gk().container[a] = {state: 1, context: d};
            ac(l)
        }
    }, Xq = function (a, b, c) {
        var d;
        ...
        if (d) if (jk()) gk().destination[a] = {
            ...
            gk().destination[a] = {state: 1, context: c};
            ac(g)
        }
    };
    ...
    function Vq() {
        ...
        return !1
    };var Yq = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/), Zq = {
            cl: ["ecl"],
        ...
        dr = function (a) {
            ...
            var c = b && Ya(Qa(b), Zq), d = Ph("gtm.blocklist") || Ph("gtm.blacklist");
            d || (d = Ph("tagTypeBlacklist")) && N(3);
            d ? N(8) : d = [];
            cr() && (d = Qa(d), d.push("nonGooglePixels", "nonGoogleScripts", "sandboxedScripts"));
    ...
    var er = {initialized: 11, complete: 12, interactive: 13}, fr = {}, gr = Object.freeze((fr[S.g.Fa] = !0, fr)),
        ...
        jr = function (a, b, c) {
            if (hl && "config" === a && !(1 < no(b).M.length)) {
                ...
                for (h in d) {
                    var l = ir(d[h], f);
                    l.length && (hr && console.log(l), g.push(h))
                }
                if (g.length) {
                    if (g.length) {
                        var n = b + "*" + g.join(".");
    ...
    function ir(a, b, c, d) {
        ...
        for (f in kr(a, b)) {
            ...
            if (n && p) ir(h, l, c, g); else if (n || p || h !== l) c[g] = !0
        }
        return Object.keys(c)
    };var lr = !1, mr = 0, nr = [];
    ...
    function or(a) {
        if (!lr) {
            ...
            if (!a || "readystatechange" != a.type || c || !b && d) {
                lr = !0;
                for (var e = 0; e < nr.length; e++) I(nr[e])
            }
            nr.push = function () {
    ...
    function pr() {
        if (!lr && 140 > mr) {
            mr++;
            try {
                G.documentElement.doScroll("left"), or()
            } catch (a) {
                m.setTimeout(pr, 50)
            }
        }
    ...
    var ur = function (a, b) {
        ...
        if (kh.hasOwnProperty(b) || "__zone" === b) return -1;
        var e = {};
        Cc(d) && (e = J(d, e));
        e.id = c;
        e.status = "timeout";
    ...
    var Ar = function () {
        ...
        if (!hh._li && m.performance && m.performance.timing) {
            var b = m.performance.timing.navigationStart, c = Da(Qh.get("gtm.start")) ? Qh.get("gtm.start") : 0;
            hh._li = {cst: a(c - b), cbt: a(yh - b)}
        }
    }, Br = function (a) {
        ...
        if (m.performance) {
            ...
            var e = hh._p || {};
            void 0 === e[a] && (e[a] = d.duration, hh._p = e);
            return d.duration
        }
    }, Dr = function () {
        var a = mc();
    ...
    var Kr = function (a) {
        ...
        return function () {
            var c = Fr(), d = c && c.getByName && c.getByName(a);
            if (d) {
    ...
    function Qr(a, b, c, d) {
        ...
        if (g && g.length) {
            var h = g[0];
            f = Qr(h.index, {X: f, W: 1 === h.Vh ? b.terminate : f, terminate: b.terminate}, c, d)
        }
        return f
    }
    ...
    function Rr(a, b, c, d) {
        function e() {
            if (f[Wd.oj]) h(); else {
                var w = He(f, c, []), x = w[Wd.zi];
                if (null != x) for (var y = 0; y < x.length; y++) if (!wj(x[y])) {
                    h();
                    return
                }
                var A = vr(c.Bb, String(f[Wd.cb]), Number(f[Wd.gd]), w[Wd.pj]), B = !1;
        ...
        var n = Ge(f[Wd.Lh], c, []);
        if (n && n.length) {
            var p = n[0], q = Qr(p.index, {X: g, W: h, terminate: l}, c, d);
            if (!q) return null;
            g = q;
            h = 2 === p.Vh ? l : q
        }
        if (f[Wd.Gh] || f[Wd.rj]) {
            var r = f[Wd.Gh] ? we : c.Vk, t = g, u = h;
            if (!r[a]) {
                e = Va(e);
                var v = Sr(a, r, e);
                g = v.X;
    ...
    var ps = function (a, b) {
        for (var c = [], d = 0; d < ve.length; d++) if (a[d]) {
            ...
            var f = yr(b.Bb);
            try {
                var g = Qr(d, {X: f, W: f, terminate: f}, b, d);
                if (g) {
                    var h = c, l = h.push, n = d, p = e["function"];
                    if (!p) throw "Error: No function name given for function call.";
                    var q = xe[p];
                    l.call(h, {ni: n, fi: q ? q.priorityOverride || 0 : 0, execute: g})
                } else ns(d, b), f()
            } catch (t) {
                f()
            }
    ...
    var rs = function (a, b) {
        if (!qs) return !1;
        var c = a["gtm.triggers"] && String(a["gtm.triggers"]), d = qs.F(a.event, c ? String(c).split(",") : []);
    ...
    function ns(a, b) {
        if (hl) {
            var c = function (d) {
                var e = b.Wf(ve[d]) ? "3" : "4", f = Ge(ve[d][Wd.Kh], b, []);
    ...
    var ys = function (a) {
        ...
        var n = a.eventCallback, p = a.eventTimeout,
            q = n;
        var r = {
            id: c, priorityId: d, name: e, Wf: dr(h), Vk: [], bi: function () {
                N(6);
                vb("HEALTH", 0)
            }, Ph: us(), Qh: vs(c), Bb: new ur(q, p)
        }, t = Qe(r);
        l && (t = ws(t));
        var u = ps(t, r), v = !1;
        v = rs(a, r.Bb);
    ...
    function ws(a) {
        for (var b = [], c = 0; c < a.length; c++) if (a[c]) {
            ...
            if (jh[d] || void 0 !== ve[c][Wd.sj] || Bh[d]) b[c] = !0;
    ...
    function xs(a, b) {
        if (!b) return b;
        for (var c = 0; c < a.length; c++) if (a[c] && ve[c] && !kh[String(ve[c][Wd.cb])]) return !0;
        return !1
    }
    ...
    var As = function (a, b, c, d) {
        ...
        if (d.da) {
            var e = Fs(a, d.da), f = e.T;
            if (f) {
                var g = J(c), h = J(e.I[d.da]), l = J(e.F), n = J(e.h),
                    p = J(a.D), q = {};
                if (hl) try {
                    q = J(Mh)
                } catch (v) {
                ...
                var r = no(d.da).prefix, t = function (v) {
                ...
                try {
                    um(d.messageContext.eventId, r, "1"), jr(d.type, d.da, u), f(d.da, b, d.B, u)
                } catch (v) {
    ...
    Es.prototype.push = function (a, b, c, d) {
        if (void 0 !== c) {
            ...
            if (c) {
                var e = no(c);
                e && 1 === Fs(this, c).status && (Fs(this, c).status = 2, this.push("require", [{}], e.V, {}))
            }
    ...
    Es.prototype.flush = function (a) {
        for (var b = this, c = [], d = !1, e = {}; this.h.length;) {
            var f = this.h[0];
            if (f.messageContext.deferrable) !f.da || Fs(this, f.da).D ? (f.messageContext.deferrable = !1, this.h.push(f)) : c.push(f), this.h.shift(); else {
                var g = void 0;
                switch (f.type) {
                    case "require":
                        g = Fs(this, f.da);
                    ...
                    case "config":
                        ...
                        var h = !!e.ub[S.g.bd];
                        delete e.ub[S.g.bd];
                        var l = no(f.da), n = l.V === l.id;
                        h || (n ? g.F = {} : g.I[f.da] = {});
                        g.D && h || Gs(this, S.g.Da, e.ub, f);
                        g.D = !0;
                        n ? J(e.ub, g.F) : (J(e.ub, g.I[f.da]), N(70));
                        d = !0;
                        break;
                    case "event":
                        g = Fs(this, f.da);
    ...
    var Hs = function (a, b) {
        if ("require" !== b.type) if (b.da) for (var c = Fs(a, b.da).B[b.type] || [], d = 0; d < c.length; d++) c[d](); else for (var e in a.B) if (a.B.hasOwnProperty(e)) {
            var f = a.B[e];
    ...
    var Ze;
    var Js = {}, Ks = {}, Ls = function (a) {
        for (var b = [], c = [], d = {}, e = 0; e < a.length; d = {Sd: d.Sd, Pd: d.Pd}, e++) {
            var f = a[e];
            if (0 <= f.indexOf("-")) d.Sd = no(f), d.Sd && (Ha(ek(), function (p) {
                return function (q) {
                    return p.Sd.V === q
                }
                ...
                for (var h = dk(), l = 0; l < h.length; l++) if (d.Pd[h[l]]) {
                    b = b.concat(ek());
                    break
                }
                var n = Ks[f] || [];
    ...
    var Os = "HA GF G UA AW DC MC".split(" "), Ps = !1, Qs = !1;

    function Rs(a, b) {
        a.hasOwnProperty("gtm.uniqueEventId") || Object.defineProperty(a, "gtm.uniqueEventId", {value: Ch()});
    ...
    var Ss = {
        config: function (a, b) {
                ...
                if (e) {
                    ...
                    if (g ? -1 === ek().indexOf(f) : -1 === dk().indexOf(f)) {
                        if (!R(61) || !d[S.g.ne]) {
                            ...
                            }) : Wq(f, h, !0, {source: 2, fromContainerExecution: b.fromContainerExecution})
                        }
                    } else {
                        if (nh && !g && !d[S.g.bd]) {
                            var l = Qs;
            ...
            if (!(2 > a.length) && k(c)) {
                ...
                e && (g.eventModel = J(e), e[S.g.fc] && (g.eventCallback = e[S.g.fc]), e[S.g.ee] && (g.eventTimeout = e[S.g.ee]));
                var h = Rs(a, b), l = h.eventId,
                    n = h.priorityId;
                ...
                void 0 === r && (r = Ph(S.g.Kb, 2), void 0 === r && (r = "default"));
                if (k(r) || Ea(r)) {
                    var t = r.toString().replace(/\s+/g, "").split(","), u = Ls(t), v = u.sk, w = u.vk;
                    if (w.length) for (var x = q && q[S.g.wa] || zs.D[S.g.wa], y = 0; y < w.length; y++) {
                        var A = no(w[y]);
                        A && Xq(A.V, x, {source: 3, fromContainerExecution: b.fromContainerExecution})
                    }
                    p = po(v)
                } else p = void 0;
                var B = p;
            ...
            if (2 == a.length && a[1].getTime) {
                Ps = !0;
                var c = Rs(a, b), d = c.eventId, e = c.priorityId, f = {};
            ...
            var c;
            2 == a.length && Cc(a[1]) ? c = J(a[1]) : 3 == a.length && k(a[1]) &&
                (c = {}, Cc(a[2]) || Ea(a[2]) ? c[a[1]] = J(a[2]) : c[a[1]] = a[2]);
            if (c) {
                var d = Rs(a, b), e = d.eventId, f = d.priorityId;
                J(c);
                var g = J(c);
    ...
    function Ys() {
        if (!Ws) {
            Ws = !0;
            for (var a = 0; a < Xs.length; a++) I(Xs[a])
        }
    }
    ...
    var Vt = function (a) {
        ...
        var c = hh[gh.ma], d = c ? c.subscribers : 1, e = 0, f = !1, g = void 0;
    ...
    function Yt(a, b) {
        ...
        if (!a.event) return !1;
        "number" !== typeof d && (d = Ch(), a["gtm.uniqueEventId"] = d, Sh("gtm.uniqueEventId", d));
        return ys(a)
    }
    ...
    function $t() {
        var a;
        if (Rt.length) a = Rt.shift(); else if (Qt.length) a = Qt.shift(); else return;
        var b;
        var c = a;
        if (St || !Zt(c.message)) b = c; else {
            St = !0;
            ...
            if (hl && Ve.N) {
                var l;
                if (Ve.Cf) {
                    var n = Ve.N, p = gk().destination[n];
                    l = p && p.context
                } else {
                    var q = Ve.N, r = gk().container[q];
                    l = r && r.context
                }
                var t = l, u, v = oi(m.location.href);
                u = v.hostname + v.pathname;
                var w = t && t.fromContainerExecution, x = t && t.source, y = Ve.N, A = Ve.Xb, B = Ve.Cf;
                Jl || (Jl = u);
            ...
            if (null == d) Tt = !1; else {
                ...
                try {
                    if (Ca(d)) try {
                        ...
                        var f = d;
                        if (k(f[0])) {
                            var g = f[0].split("."), h = g.pop(), l = f.slice(1), n = Ph(g.join("."), 2);
                            if (null != n) try {
                                n[h].apply(n, l)
                            } catch (x) {
                            }
                    ...
                    if ("number" === typeof u) {
                        for (var v = Pt[String(u)] || [], w = 0; w < v.length; w++) Rt.push(bu(v[w]));
                        v.length && Rt.sort(Ut);
                        delete Pt[String(u)];
                        u > Ot && (Ot = u)
                    }
    ...
    function cs(a) {
        if (Ot < a.notBeforeEventId) {
            ...
            Pt[b] = Pt[b] || [];
            Pt[b].push(a)
        } else Rt.push(bu(a)), Rt.sort(Ut), I(function () {
            Tt || au()
        })
    }
    ...
    var eu = function () {
        ...
        var b = Wb(gh.ma, []), c = hh[gh.ma] = hh[gh.ma] || {};
        !0 === c.pruned && N(83);
        Pt = as().get();
        ds();
        qr(function () {
        ...
        b.push = function () {
            ...
            if (0 < hh.SANDBOXED_JS_SEMAPHORE) {
                f =
                    [];
                for (var g = 0; g < arguments.length; g++) f[g] = new Nt(arguments[g])
    ...
    var uu = !!m.MutationObserver, vu = void 0, wu = function (a) {
        if (!vu) {
            var b = function () {
                var c = G.body;
                if (c) if (uu) (new MutationObserver(function () {
                    for (var e = 0; e < vu.length; e++) I(vu[e])
    ...
    var Iu = m.clearTimeout, Ju = m.setTimeout, U = function (a, b, c, d) {
            if (bk()) {
                b && I(b)
    ...
    function wv(a, b, c) {
        var d = c ? "i" : void 0;
        try {
            var e = String(b) + d, f = vv.get(e);
            f || (f = new RegExp(b, d), vv.set(e, f));
            return f.test(a)
        } catch (g) {
            return !1
        }
    ...
    function xv(a, b) {
        function c(g) {
            var h = oi(g), l = mi(h, "protocol"), n = mi(h, "host", !0), p = mi(h, "port"),
    ...
    var Iv;
    var Jv = function (a) {
        for (var b = 0; b < a.length; ++b) if (Iv) try {
            a[b]()
        } catch (c) {
            N(77)
        } else a[b]()
    ...
    function Kv(a, b, c) {
        var d = this, e;
        K(F(this), ["eventName:!string", "callback:!Fn", "triggerId:?string"], arguments), Jv([function () {
    ...
    function Jw(a, b) {
        ...
        var d = Ec(b) || {}, e = Ec(a, this.h, 1).getProcessedEvent(), f = new Do(e.target, e.eventName, e.s);
    ...
    var jx = function (a, b) {
        ...
        var a = m.location.href,
            b = {source: null, state: m.history.state || null, url: ni(oi(a)), U: mi(oi(a), "fragment")};
        return function (c, d) {
            var e = b, f = {};
            f[e.source] = !0;
            f[c.source] = !0;
        ...
        if (Ca(d)) try {
            c[a] = function (e, f, g) {
                ...
                b({source: a, state: e, url: ni(oi(h)), U: mi(oi(h), "fragment")})
            }
        } catch (e) {
        }
    }, mx = function (a) {
        m.addEventListener("popstate", function (b) {
            var c = lx(b);
            a({
                source: "popstate", state: b.state, url: ni(oi(c)),
                U: mi(oi(c), "fragment")
            })
        })
    }, nx = function (a) {
        m.addEventListener("hashchange", function (b) {
            var c = lx(b);
            a({source: "hashchange", state: null, url: ni(oi(c)), U: mi(oi(c), "fragment")})
        })
    }, lx = function (a) {
    ...
    function ox(a, b) {
        ...
        if (nu("ehl", "init", !1)) {
            ...
            var f = function (g) {
                for (var h = 0; h < hx.length; h++) hx[h](g)
            };
            nx(f);
            mx(f);
            kx("pushState",
    ...
    var px = function (a, b) {
            ...
            if (0 < d) {
                var f = ni(oi(c)), g = ni(oi(m.location.href));
                return f !== g
            }
            return !0
        }, qx = function (a, b) {
            for (var c = mi(oi((b.attributes && b.attributes.formaction ? b.formAction : "") || b.action || lc(b, "href") || b.src || b.code || b.codebase || ""), "host"), d = 0; d < a.length; d++) try {
            ...
            var a = 0, b = function (c) {
                ...
                if (d && 3 !== c.which && !(c.Xf || c.timeStamp && c.timeStamp === a)) {
                    ...
                    for (var h = [], l = 0; l < g.length; l++) {
                        var n = g[l], p = nu("aelc", "aff.map", {})[n];
                        p && !qx(p, d) || h.push(n)
                    }
                    if (h.length) {
                        var q = px(c, d), r = ju(d, "gtm.linkClick", h);
                        ...
                        if (q && !e && f && d.href) {
                            ...
                            }), u = m[(lc(d, "target") || "_self").substring(1)], v = !0, w = Xt(function () {
                                var x;
                                if (x = v && u) {
                                    var y;
                                    a: if (t) {
                            ...
                            if (Wt(r, w, f)) v = !1; else return c.preventDefault &&
    ...
    function sx(a, b) {
        ...
        nu("aelc", "init", !1) || (rx(), lu("aelc", "init", !0));
        return b
    }
    ...
    var vx = function (a) {
        ...
        b && (Array.isArray(a) || (a = [a]), mu("sdl", c, function (d) {
        ...
        var c = 0, d = !1, e = function () {
            d ? c = m.setTimeout(e, a) : (c = 0, xx(), nu("sdl", "init", !1) && !yx() && (fc(m, "scroll", f), fc(m, "resize", f), lu("sdl", "init", !1)));
            d = !1
        }, f = function () {
            b && tx();
            c ? d = !0 : (c =
                m.setTimeout(e, a), lu("sdl", "pending", !0))
        };
        return f
    }, xx = function () {
        var a = tx(), b = a.Nf, c = a.Of, d = b / ux.scrollWidth * 100, e = c / ux.scrollHeight * 100;
        ...
        for (g in e) {
            ...
            if (e.hasOwnProperty(f.Vb)) {
                ...
                if (!(a < h)) {
                    var l = {};
                    Vt((l.event = "gtm.scrollDepth", l["gtm.scrollThreshold"] = h,
    ...
    function Dx(a, b) {
        ...
        nu("sdl", "init", !1) ? nu("sdl", "pending", !1) || I(function () {
            return xx()
        }) : (lu("sdl", "init", !0), lu("sdl", "pending", !0), I(function () {
            xx();
            if (yx()) {
                var e = zx();
                ec(m, "scroll", e);
    ...
    var Hx = function (a, b, c) {
        var d = a.map(function (g) {
            return {xa: g, Id: g, Fd: void 0}
        });
        if (!b.length) return d;
        var e = b.map(function (g) {
            return {xa: g * c, Id: void 0, Fd: g}
        });
        ...
        function e() {
            t = Hu(function () {
                return {url: w, title: x, Pf: v, Th: a.getCurrentTime(), playbackRate: y}
            }, b.ib, a.getIframe());
            v = 0;
            x = w = "";
            y = 1;
        ...
        function r() {
            if (u.length && 0 !== y) {
                ...
                c = function () {
                    d = 0;
                    c = p;
                    0 < u.length && u[0].xa === H.xa && (u.shift(), Vt(t.createEvent("progress", H.Fd, H.Id)));
                    r()
                };
        ...
        function (a) {
            I(function () {
                function b() {
                    for (var d = c.getElementsByTagName("iframe"), e = d.length, f = 0; f < e; f++) Lx(d[f], a)
                }
        ...
        if (!a.getAttribute("data-gtm-yt-inspected-" + b.ib) && (Rb(a, "data-gtm-yt-inspected-" + b.ib), Nx(a, b.ud))) {
            a.id || (a.id = Ox());
        ...
        if (Px(c, "embed/")) {
            ...
            if (b) {
                var d;
                var e = -1 !== c.indexOf("?") ? "&" : "?";
                -1 < c.indexOf("origin=") ? d = c + e + "enablejsapi=1" : (Fx || (Fx = G.location.protocol + "//" + G.location.hostname, G.location.port && (Fx += ":" + G.location.port)), d = c + e + "enablejsapi=1&origin=" + encodeURIComponent(Fx));
                var f;
                f = Eb(d);
                a.src = Db(f).toString();
                return !0
        ...
        if (!a) return !1;
        for (var c = 0; c < Ex.length; c++) if (0 <= a.indexOf("//" + Ex[c] + "/" + b)) return !0;
        return !1
    }, Ox = function () {
        var a =
    ...
    function Qx(a, b) {
        ...
        var n = {Jf: d, Hf: e, If: f, mg: g, ng: h, ud: l, ib: b}, p = m.YT, q = function () {
            Mx(n)
        };
        ...
        I(function () {
            for (var t = G.getElementsByTagName("script"), u = t.length, v = 0; v < u; v++) {
                ...
                if (Px(w, "iframe_api") || Px(w, "player_api")) return b
            }
            for (var x = G.getElementsByTagName("iframe"), y = x.length, A = 0; A < y; A++) if (!Gx && Nx(x[A], n.ud)) return ac("https://www.youtube.com/iframe_api"),
                Gx = !0, b
        });
        return b
    }
    ...
    var Tx = function (a, b) {
        ...
        if (a) {
            if (void 0 !== a.contextValue) return Ux(a.contextValue, b);
            if (void 0 !== a.booleanExpressionValue) return Sx(a.booleanExpressionValue, b);
    ...
    var Zx = function (a, b, c) {
        if (c) switch (c.type) {
            ...
            case "event_param":
                ...
                if (d === S.g.lf) return Yx(b);
                return b[d]
        }
    }, cy = function (a, b, c, d) {
        $x = !1;
        if (c && !ay(a, b, c)) return !1;
        if (!d || 0 === d.length) return !0;
        for (var e = 0; e < d.length; e++) if (by(a, b, d[e].predicates || [])) return !0;
        return !1
    }, by = function (a, b, c) {
        for (var d = 0; d < c.length; d++) if (!ay(a,
            b, c[d])) return !1;
        return !0
    }, ay = function (a, b, c) {
        var d = c.values || [], e = Zx(a, b, d[0]), f = Zx(a, b, d[1]), g = c.type;
    ...
    function my(a, b) {
        ...
        var d = mi(oi(m.location.href), "query"), e = ji(d, a, b);
        c = Dc(e, this.h);
        return c
    }
    ...
    function ry(a) {
        var b = "";
        K(F(this), ["component:?string"], arguments), M(this, "get_url", a), b = mi(oi(m.location.href), a);
        return b
    }
    ...
    var By = Object.freeze({dl: 1, id: 1}), Cy = {};
    ...
    function Ry(a, b) {
        var c = this;
        K(F(this), ["destinationId:!string", "callback:!Fn"], arguments), Jo(a, function (d) {
            b.h(c.h, Dc(d, c.h, 1))
        });
    }
    ...
    var $y = !1, az = function (a) {
        var b = a.eventName === S.g.Ic && kj() && Xy(a), c = a.metadata.batch_on_navigation,
            d = a.metadata.is_conversion, e = a.metadata.is_session_start, f = a.metadata.create_dc_join,
            g = a.metadata.create_google_join, h = a.metadata.euid_mode_enabled && !!Yy(a);
    ...
    var kz = function (a, b, c) {
            ...
            var c;
            var d = b.metadata.cookie_options, e = d.prefix + "_ga", f = Sm(d, void 0, void 0, S.g.Z);
            if (!1 === T(b.s, S.g.Hb) && lz(b) === a) c = !0; else {
                var g = Zj(a, mz[0], d.domain, d.path);
                c = 1 !== Rj(e, g, f)
            }
            return c
        }, lz = function (a) {
            var b = a.metadata.cookie_options, c = b.prefix + "_ga", d = Yj(c, b.domain, b.path, mz, S.g.Z);
            if (!d) {
        ...
        mz = ["GA1"], oz = function (a, b) {
            var c = a.C[S.g.xb];
            if (b && c === b) return c;
            if (c) {
                c = "" + c;
                if (!nz(c, a)) return N(31), a.K = !0, "";
                jz(c, wj(S.g.Z));
                return c
            }
            N(32);
    ...
    var rz = function (a, b, c) {
        ...
        if (!(Math.floor(c.metadata.event_start_timestamp_ms / 1E3) > d.Bd + 60 * f)) return a;
        var g = pz(b);
        if (!g) return a;
        g.Sb = d.Sb + 1;
        var h;
        ...
        var c = b.metadata.cookie_options, d = sz(b, c), e = Zj(a, tz[0], c.domain, c.path), f = {
            Db: S.g.Z,
            domain: c.domain,
            path: c.path,
        ...
        var b = a.metadata.cookie_options, c = sz(a, b), d = Yj(c, b.domain, b.path, tz, S.g.Z);
        if (!d || !hl && !R(52)) return d;
    ...
    }, tz = ["GS1"], sz = function (a, b) {
        return b.prefix + "_ga_" + a.target.M[0]
    }, pz = function (a) {
        if (a) {
            var b = a.split(".");
            if (!(5 > b.length || 7 < b.length)) return 7 > b.length && N(67), {
                sessionId: b[0],
                Sb: Number(b[1]),
                xc: !!Number(b[2]),
                Bd: Number(b[3]),
    ...
    var xz = function (a) {
        ...
        var c = tn(!0);
        return "1" !== c._up ? {} : {clientId: c[a], li: c[b]}
    }, zz = function (a, b, c) {
        var d = tn(!0), e = d[b];
        e && (kz(a, e, 2), nz(e, a));
        var f = d[c];
        ...
        var b = xz(a) || {}, c = a.metadata.cookie_options, d = c.prefix + "_ga", e = sz(a, c);
        ...
        var b = a.metadata.cookie_options, c = b.prefix + "_ga", d = sz(a, b);
        An(function () {
            var e;
            if (wj("analytics_storage")) e = {}; else {
                var f = {};
                e = (f._up = "1", f[c] = a.C[S.g.xb], f[d] = wz(a), f)
            }
            return e
        }, 1);
        return !wj("analytics_storage") && Cz() ? yz(c, d) : {}
    }, Cz = function () {
        var a = li(m.location, "host"), b = li(oi(G.referrer), "host");
        return a &&
    ...
    var Iz = function (a, b) {
        ...
        void 0 === c && (c = {});
        if ("object" === typeof b) for (var d in b) Kz(a + "." + d, b[d], c); else c[a] = b;
        return c
    }, Nz = function (a) {
    ...
    Qz[S.g.Dh] = "_glv";
    Qz[S.g.rf] =
        "uaa", Qz[S.g.sf] = "uab", Qz[S.g.tf] = "uafvl", Qz[S.g.ph] = "uamb", Qz[S.g.uf] = "uam", Qz[S.g.vf] = "uap", Qz[S.g.wf] = "uapv", Qz[S.g.qh] = "uaW", Qz[S.g.xf] = "uaw";
    var Rz = {};
    Rz[S.g.Ab] = "sid";
    Rz[S.g.qe] = "sct";
    Rz[S.g.pe] = "seg";
    ...
    Tz[S.g.ae] = "cs";
    Tz[S.g.be] = "ck";
    var Uz = {}, Vz = Object.freeze((Uz[S.g.ka] = !0, Uz)), Mz = function () {
        var a = "www";
        Pz && Oz && (a = Oz);
        ...
        if (a.metadata.is_ecommerce) {
            ...
            if (Ea(h)) for (var l = 0; l < h.length && 200 > l; l++) e["pr" + (l + 1)] = mf(h[l])
        }
        var n = a.C[S.g.hc];
        n && (e.edid = n);
        var p = function (v, w) {
            ...
            if (R(23)) return !1;
            var x = v.split(".");
            if (v === S.g.ka && "object" !== typeof w) return p(v,
                w), !0;
            if (x[0] === S.g.ka) {
        ...
        Ma(a.C, function (v, w) {
            if (void 0 !== w && !Ug.hasOwnProperty(v)) {
                null === w && (w = "");
                var x;
                v !== S.g.Uc ? x = !1 : a.metadata.euid_mode_enabled ? (d.ecid = w, x = !0) : x = void 0;
                if (!x && v !== S.g.ef) {
                    var y = w;
                    !0 === w && (y = "1");
                    !1 === w && (y = "0");
                    var A;
                    if (Qz[v]) A = Qz[v], d[A] = ff(y, 420); else if (Rz[v]) A = Rz[v],
                        f[A] = ff(y, 420); else if (Sz[v]) A = Sz[v], e[A] = ff(y, 420); else if ("_" === v.charAt(0)) d[v] = ff(y, 420); else if (R(65) && v === S.g.fd) r(v, w); else {
                        var B;
                        (B = q(v, w)) || (Tz[v] ? B = !0 : v !== S.g.Oc ? B = !1 : ("object" !== typeof w && p(v, w), B = !0));
                        B || p(v, w)
                    }
                }
            }
        ...
        Ma(t, function (v, w) {
            if (void 0 !== w) if (null === w && (w = ""), v === S.g.Aa && !f.uid) f.uid = ff(w, 36); else if (b[v] !== w) {
                var x = (Da(w) ?
                    "upn." : "up.") + ff(v, 24);
                e[x] = ff(w, 36);
                b[v] = w
        ...
        var u = !1;
        return of.call(this, {Ha: d, Tb: f, Qf: e}, Nz(a), Xy(a), u) || this
    };
    na(Wz, of);
    var Xz = function (a, b) {
        ...
        c.withCredentials = !0;
        var d = b ? "POST" : "GET", e = "", f = 0, g = oi(a), h = Zz(g), l = Yz(g);
        c.onprogress = function (n) {
            if (200 ===
                ...
                for (var p = Xz(e, h), q = p.indexOf("\n\n"); -1 !== q;) {
                    ...
                    if (r) {
                        var y = r.send_pixel || [];
                        if (Array.isArray(y)) for (var A = 0; A < y.length; A++) dc(y[A])
                    }
                    p = p.substring(q +
                        2);
                    q = p.indexOf("\n\n")
    ...
    var cA = function (a, b, c, d) {
        ...
        eA = function (a, b) {
            ...
            var d = b.Qk, e = b.Rk, f = b.Zj, g = b.Aj, h = b.zj, l = b.gk, n = b.Sk, p = b.fk;
            if (d || e || n) {
                var q = [];
                c("tid");
                c("cid");
                ...
                d && (bA("https://stats.g.doubleclick.net/g/collect", "v=2&" + q.join("&")), rj("https://stats.g.doubleclick.net/g/collect?v=2&" +
                    q.join("&")));
                if (e) {
                    q.push("z=" + Ja());
                    if (!l) {
    ...
    fA.prototype.D = function (a, b) {
        ...
        if (e && this.h.add(d)) {
            ...
            var l = a.metadata.create_dc_join, n = a.metadata.create_google_join, p = !1 !== T(a.s, S.g.Ea),
                q = !1 !== T(a.s, S.g.fa), r = {eventId: a.s.eventId, priorityId: a.s.priorityId}, t = {
                    Qk: l,
                    Rk: n,
    ...
    }, hA = ok('', 500), iA = ok('', 5E3), gA = !0;
    var jA = window, kA = document, lA = function (a) {
        var b = jA._gaUserPrefs;
        if (b && b.ioo && b.ioo() || a && !0 === jA["ga-disable-" + a]) return !0;
        try {
            var c = jA.external;
            if (c && c._gaUserPrefs && "oo" == c._gaUserPrefs) return !0
        } catch (f) {
        }
        for (var d = Cj("AMP_TOKEN", String(kA.cookie), !0), e = 0; e < d.length; e++) if ("$OPT_OUT" == d[e]) return !0;
    ...
    var mA = function (a, b, c) {
        ...
        void 0 === c && (c = {});
        if ("object" === typeof b) for (var d in b) oA(a + "." + d, b[d], c); else c[a] = b;
        return c
    }, pA = !1;
    var Pm = {Lj: "", bl: Number("")}, qA = {},
        rA = (qA[S.g.Wd] = !0, qA[S.g.Xd] = !0, qA[S.g.Yd] = !0, qA[S.g.Zd] = !0, qA[S.g.ae] = !0, qA[S.g.be] = !0, qA),
        sA = function (a) {
            this.T = a;
            this.Ca = new fA;
            this.B = void 0;
    ...
    aa.Ek = function (a) {
        this.D = a;
        try {
            lA(a.target.V) && (N(28), a.K = !0);
            if (0 <= Pm.Lj.replace(/\s+/g, "").split(",").indexOf(a.eventName)) a.K = !0; else {
                var b = Zy(a);
            ...
            if (r) {
                var t = oi(r).search.replace("?", ""), u = ji(t, "_gl", !1, !0) || "";
                p = u ? void 0 !== un(u, q) : !1
            } else p = !1;
            p && Xy(a) && (a.C[S.g.Dh] = !0);
            a.eventName ===
            S.g.Da ? (T(a.s, S.g.qb) && bo(["aw", "dc"]), Bz(a), n = Dz(a)) : n = {};
            l.call(this, n);
            ...
            w && (a.C[S.g.hc] = w);
            var x = this.h, y = this.F, A = !this.Dc, B = this.B, C = T(a.s, S.g.xb), E = C ? 1 : 8;
            ...
            C ? C = "" + C : (C = Vj(), E = 7, a.metadata.is_first_visit = a.metadata.is_new_to_site = !0);
            kz(a, C, E);
            ...
            X = Math.min(475, X);
            X = Math.max(5, X);
            var ja = Oa(T(a.s, S.g.pf, 1E4)), O = pz(P);
            a.metadata.is_first_visit = !1;
            a.metadata.is_session_start = !1;
            a.metadata.join_timer_sec = 0;
            O && O.ag && (a.metadata.join_timer_sec = Math.max(0, O.ag - Math.max(0, L - O.Bd)));
            var Q = !1;
            O || (Q = a.metadata.is_first_visit =
                !0, O = {sessionId: String(L), Sb: 1, xc: !1, Bd: L, Qb: !1, od: void 0});
            L > O.Bd + 60 * X && (Q = !0, O.sessionId = String(L), O.Sb++, O.xc = !1, O.od = void 0);
            if (Q) a.metadata.is_session_start = !0, y.bk(a); else if (y.Xj() > ja || a.eventName == S.g.Ic) O.xc = !0;
            a.metadata.euid_mode_enabled ? T(a.s, S.g.Aa) ? O.Qb = !0 : (O.Qb && (O.od = void 0), O.Qb = !1) : O.Qb = !1;
            var la = O.od;
            if (a.metadata.euid_mode_enabled) {
                var ca = T(a.s, S.g.Uc), V = ca ? 1 : 8;
                ca || (ca = la, V = 4);
                ca || (ca = Uj(), V = 7);
                var Fa = V, Za = a.metadata.enhanced_client_id_source;
                if (void 0 === Za || Fa <= Za) a.C[S.g.Uc] =
                    ca.toString(), a.metadata.enhanced_client_id_source = Fa
            }
            A ? (Eo(a, S.g.Ab, O.sessionId), Eo(a, S.g.qe, O.Sb), Eo(a, S.g.pe, O.xc ? 1 : 0)) : (a.C[S.g.Ab] = O.sessionId, a.C[S.g.qe] = O.Sb, a.C[S.g.pe] = O.xc ? 1 : 0);
            ...
            a: {
                ...
                if (void 0 !== hh.ga4_referrer_override) qc = hh.ga4_referrer_override; else {
            ...
            if (!a.metadata.is_merchant_center && !1 !== T(a.s, S.g.bc) && Gz() && wj(S.g.J)) {
                ...
                Eh && 0 === (lt || 0) && (a.metadata.join_timer_sec = 60, a.metadata.create_google_join = !0)
            }
            wA(a);
            Yg.hasOwnProperty(a.eventName) && (a.metadata.is_ecommerce =
            ...
            if (void 0 !== T(a.s, S.g.me)) Eo(a, S.g.me); else {
                var pt = T(a.s, S.g.oe), ql, Fh;
                a: {
                    if (Az) {
                        var rl = xz(a) || {};
                        if (rl && rl[S.g.aa]) for (var qt = mi(oi(a.C[S.g.Sa]),
                ...
                if (!(ql = Fh)) {
                    var Hh;
                    if (Hh = pt) a: {
                        for (var rt = pt.include_conditions || [], cD = mi(oi(a.C[S.g.Sa]), "host", !0), sl = 0; sl < rt.length; sl++) if (rt[sl].test(cD)) {
                            Hh = !0;
                            break a
                        }
                        Hh = !1
            ...
            a: if (R(11)) if (R(25) &&
            (a.C[S.g.qh] = "1"), !Lm(m)) N(87); else if (void 0 !== Nm) {
                N(85);
                var st = Jm();
                if (st) {
                    if (R(59)) {
                        if (T(a.s, S.g.Zc) && !Xy(a)) break a
            ...
            if (a.eventName == S.g.Ka) {
                var tt = T(a.s, S.g.ab), eD = T(a.s, S.g.pb), ut = void 0;
                ut = a.C[tt];
                eD(ut || T(a.s, tt));
                a.K = !0
            }
                ...
                if (tl) {
                    ...
                    for (var vt = tl.edit_rules || [], wt = !1, ul = 0; ul < vt.length; ul++) {
                        ...
                        a: {
                            var Jh = a, Id = vt[ul];
                            if (cy(Jh.eventName,
                                Hd, Id.event_name_predicate, Id.conditions || [])) {
                    ...
                    for (var yt = tl.synthesis_rules || [], vl = 0; vl < yt.length; vl++) {
                        ...
                        if (cy(wl.eventName, Hd, If.event_name_predicate, If.conditions || [])) {
                            ...
                            if (!dz(xl)) {
                                ...
                                ez(xl, zt,
                                    If);
                                var At = {}, yl = {eventMetadata: (At.syn_or_mod = !0, At)};
                    ...
                    if (wt) {
                        for (var zl = {}, Bt = {eventMetadata: (zl.syn_or_mod = !0, zl.is_external_event = !!a.s.eventMetadata.is_external_event, zl)}, Ct, Al = [], Dt = ub.GA4_EVENT || [], Kh = 0; Kh < Dt.length; Kh++) Dt[Kh] && Al.push(Kh);
            ...
            if (Ea(Bl)) for (var Cl = 0; Cl < Bl.length; Cl++) bz(Bl[Cl]);
            var Et = xb("GA4_EVENT");
            Et && (a.C._eu = Et);
            Eo(a, S.g.Aa);
            Eo(a, S.g.Ta);
            ...
            T(a.s, S.g.Zc) && (a.C[S.g.Zc] = !0, mA(a, S.g.Jb));
            Eo(a, S.g.Yg);
            if (a.K) {
                a.s.W();
                wb();
                ...
                if (c ^ d && b.D && b.h && b.B) {
                    ...
                    if (d) {
                        ...
                        if (f) {
                            b.B = f;
                            var g = vz(b.D);
                            g ? R(12) ? (b.h = rz(g, b.h, b.D), uz(b.h, b.D)) :
                                b.h = g : uz(b.h, b.D)
                        } else nz(b.B, b.D), jz(b.B, !0), uz(b.h, b.D);
                        var h = {};
                        h[S.g.hf] = e;
    ...
    function tA(a) {
        ...
        if (!zA(a)) {
            var b = !1, c = function () {
                !b && zA(a) && (b = !0, fc(G, "visibilitychange", c), N(55))
            };
    ...
    function BA(a, b) {
        ...
        var d = new sA(a.id), e = "MC" === a.prefix;
        c = function (f, g, h, l) {
    ...
    function DC(a) {
        ...
        var f = this.h.h, g = f.eventId, h = uy(f), l = Wr("consent", "default", Ec(a));
        bs(l, g, h)
    }
    ...
    JC.removeItem = function (a) {
        ...
        var c = b.vd();
        if (!KC[c] || !KC[c].hasOwnProperty("gtm." + a)) return;
        delete KC[c]["gtm." + a];
    };
    JC.clear = function () {
        M(this, "access_template_storage");
    ...
    function RC() {
        ...
        return function (b, c, d) {
            ...
            var g = {
                ...
                Nj: {index: d && d.index, type: d && d.type, name: d && d.name}
            };
            if (OC()) {
                var h = PC(), l = void 0, n = void 0;
                g.Wa = {
                    ug: [], jd: {}, fb: function (q, r, t) {
                        1 === r && (l = q);
                        7 === r && (n =
                            t);
                        h(q, r, t)
    ...
    };var VC = encodeURI, Y = encodeURIComponent, WC = function (a, b, c) {
        dc(a, b, c)
    }, XC = function (a, b) {
        if (!a) return !1;
        var c = mi(oi(a), "host");
    ...
    Z.m.v = ["google"], function () {
        (function (a) {
            ...
            var c = Ou(b.replace(/\\\./g, "."), a.vtp_dataLayerVersion || 1), d = void 0 !== c ? c : a.vtp_defaultValue;
    ...
    Z.m.gct = ["google"], function () {
        ...
        (function (d) {
            ...
            e[g] = h;
            var l = S.g.oe, n = d.vtp_referralExclusionDefinition;
            n && n.include_conditions && (n.include_conditions = a(n.include_conditions));
            e[l] = n;
            var p = d.vtp_trackingId, q = Fs(zs, p).h, r = q.referral_exclusion_conditions;
            r && (r.length && "object" === typeof r[0] && (r = c(r)), e[S.g.oe] = {include_conditions: a(r)});
            var t = q.cross_domain_conditions;
            if (t) {
                t.length && "object" === typeof t[0] && (t = c(t));
                var u = {};
                e[S.g.za] = (u[S.g.aa] = a(t), u[S.g.kc] = !0, u[S.g.jc] = !0, u[S.g.Yc] = "query", u)
            }
            Is(p, e);
    ...
    (function (a) {
        ...
        if (uh) a(); else {
            var f = function (u) {
                    ...
                    var y = {
                        ...
                        data: {scriptSource: Vb, containerProduct: v, debug: !1, id: Ve.N, isGte: nh}
                    };
                    ...
                    x.push(y)
                }, g = {kl: 1, gj: 2, tj: 3, Ci: 4, fj: 5}, h = void 0, l = void 0,
        ...
        if (Ve.Xb ? hh["ctid_" + Ve.Xb] : hh[Ve.N]) {
            ...
            if (void 0 !==
                u) for (var H = ["sandboxedScripts"], D = 0; D < u.length; D++) {
                var L = u[D].replace(/^_*/, "");
                Ah[L] = H
            }
            UC(v);
            if (void 0 !== w) for (var P = 0; P < w.length; P++) Bh[w[P]] = !0;
            rE();
            eu();
            lr = !1;
            mr = 0;
            if ("interactive" == G.readyState && !G.createEventObject || "complete" == G.readyState) or(); else {
            ...
            Cm();
            R(46) && (N(111), vb("HEALTH", 1));
            R(47) && (N(112), vb("HEALTH", 2));
            yh = Ta();
            qE.bootstrap =
                yh;
            if (a) {
